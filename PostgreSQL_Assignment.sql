...
-- Create a "students" table with the specified fields.
...
-- Create a "courses" table with the specified fields.
...
-- Create an "enrollment" table with the specified fields.
...
-- Replace YourName, YourAge, YourEmail, and YourMark with your own details.
INSERT INTO students (student_name, age, email, frontend_mark, backend_mark, status)
VALUES
    ('Jerry', 20, 'jerry@gmail.com', 60, 40, NULL);
...
-- Query 3: Update the status of the student with the highest total mark to 'Awarded'.
UPDATE students
SET status = 'Awarded'
WHERE student_id = (
    SELECT student_id
